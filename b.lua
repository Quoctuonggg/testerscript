...
local Window = OrionLib:MakeWindow({Name = "QTuong Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "HHubPaid"})
...
SettingsTab:AddLabel("Name : Tran Quoc Tuong")

SettingsTab:AddLabel("Age : 14")

SettingsTab:AddLabel("Living : Viet Nam")

SettingsTab:AddLabel("Discord")

SettingsTab:AddLabel("Mobile/PC : Support")

...
Main:Label("Welcom " ..game.Players.LocalPlayer.Name.. "")
        ...
        while wait() do
            pcall(function()
                if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
                    Elite_Hunter_Status:Set("Elite : Is Spawning!")    
                else
                    Elite_Hunter_Status:Set("Elite : Not Spawning!") 
                end
            end)
        end
    end)
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  ...
  RaceV4:AddToggle("Auto Complete Trial Race Fish",false,function(v)
...
spawn(function()
  ...
  RaceV4:AddToggle("Auto Complete Trial All Race ( No Fish )",_G.AutoQuestRace,function(v)
  _G.AutoQuestRace = v

...
sever.Name = "sever"
sever.Parent = ScreenGui
sever.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
sever.BorderColor3 = Color3.fromRGB(0, 0, 0)
sever.BorderSizePixel = 0
sever.Position = UDim2.new(0.930088699, 0, 0.601923108, 0)
sever.Size = UDim2.new(0.062432725, 0, 0.0596153848, 0)
sever.Font = Enum.Font.SourceSans
sever.Text = "Hop"
sever.TextColor3 = Color3.fromRGB(0, 0, 0)
sever.TextScaled = true
sever.TextSize = 14.000
sever.TextWrapped = true

UICorner.CornerRadius = UDim.new(0, 20)
UICorner.Parent = sever

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(74, 255, 201)), ColorSequenceKeypoint.new(0.29, Color3.fromRGB(119, 250, 127)), ColorSequenceKeypoint.new(0.55, Color3.fromRGB(217, 246, 150)), ColorSequenceKeypoint.new(0.77, Color3.fromRGB(242, 201, 130)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 153, 153))}
UIGradient.Parent = sever

TextButton.Parent = sever
TextButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextButton.BackgroundTransparency = 1.000
TextButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton.BorderSizePixel = 0
TextButton.Position = UDim2.new(-0.103447914, 0, -1.54838681, 0)
TextButton.Size = UDim2.new(1.18965518, 0, 1.54838705, 0)
TextButton.ZIndex = -1
...
TextButton.TextStrokeColor3 = Color3.fromRGB(255, 24, 7)
TextButton.TextWrapped = true

UICorner_2.CornerRadius = UDim.new(0, 20)
UICorner_2.Parent = TextButton

UIStroke.Thickness = 3.9000000953674316
UIStroke.Parent = TextButton

-- Scripts:

local function GDOJD_fake_script() -- UIGradient.Script 
...
coroutine.wrap(GDOJD_fake_script)()
local function IGCGG_fake_script() -- TextButton.Script 
...
coroutine.wrap(IGCGG_fake_script)()
local function JMFRW_fake_script() -- sever.LocalScript 
	local script = Instance.new('LocalScript', sever)
...
coroutine.wrap(JMFRW_fake_script)()
